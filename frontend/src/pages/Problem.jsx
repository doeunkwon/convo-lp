...
function Problem() {
    return (
        <main className='Problem'>
            ...
            <p>Source: [Stat 1] National Institute of Mental Health (NIMH), based on the National Comorbidity Survey Replication (NCS-R). [Stat 2 & 3] Jefferies P, Ungar M (2020) Social anxiety in young people: A prevalence study in seven countries. PLoS ONE 15(9): e0239133.</p>
        </main>
    )
}
